...
const tabsFind = `      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 pb-4 mt-2">
...
const tabsReplace = `      <div className="flex flex-wrap lg:flex-nowrap justify-between items-center gap-4 pb-4 mt-2 w-full">
