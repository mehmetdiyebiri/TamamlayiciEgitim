...
const targetButtons = `      <div className="flex flex-wrap lg:flex-nowrap justify-between items-center gap-4 pb-4 mt-2 w-full">
...
// And add it inside the lg:col-span-2 block
const destFind = `      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-6">
          <div className="lg:col-span-2 space-y-4">`;
          
const destReplace = `      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-6">
          <div className="lg:col-span-2 space-y-4">
${targetButtons}`;

code = code.replace(destFind, destReplace);
