...
export const INITIAL_BEHAVIOR_CONFIG = {
    ...
    behaviors: {
        ...
        'yellow': [
            { id: 1, text: "Bilerek Derse Geç Kalma", points: -2, task: "Geç Çıkma Cezası" },
            { id: 2, text: "Sırada Başkasının Önüne Geçme", points: -2, task: "Arkaya Geçme" },
            { id: 3, text: "Koridorda Koşma / Gürültü", points: -2, task: "Sözlü Uyarı" },
            { id: 4, text: "Ödevi İlk Kez Yapmama", points: -2, task: "Tahtada Soru Çözme" },
            { id: 5, text: "Yanlışı Herkesin İçinde Tekrar Etme", points: -2, task: "Sunum Yaptırma" },
            { id: 6, text: "Törende Olumsuz Davranış", points: -2, task: "Aktif Görev" },
            { id: 7, text: "Ödevi 2. Kez Yapmama", points: -2, task: "Kütüphane Ödevi" },
            { id: 8, text: "Koridorda Top Sektirme (3. Kez)", points: -2, task: "1 Hafta Men" },
            { id: 9, text: "Ders Zili Sonrası Sınıfa Gelmeme", points: -2, task: "Beden Dersi Kısıtı" }
        ],
        'red': [
