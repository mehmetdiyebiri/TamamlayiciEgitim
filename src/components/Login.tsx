...
export const Login = ({ state, actions }: any) => {
  ...
  React.useEffect(() => {
    ...
    // Canlı Firestore senkronizasyonu: Vercel veya herhangi bir cihazda açıldığında anında logoyu çeker
  ...
  const activeLogo = customLogo || selectedSchool?.logoUrl;
      ...
      <div className="bg-white p-6 md:p-14 rounded-[48px] shadow-[0_24px_80px_rgba(0,0,0,0.06)] border border-gray-100 w-full max-w-xl animate-in fade-in zoom-in-95 duration-700">
        <div className="text-center mb-6">
          <div className="flex items-center justify-center">
            {activeLogo ? (
              <div className="w-full max-w-full h-44 sm:h-52 md:h-60 flex items-center justify-center px-4 py-2 transition-all">
                <img 
                  src={activeLogo} 
                  alt="Logo" 
                  className="max-h-full max-w-full w-auto h-auto object-contain filter drop-shadow-sm select-none"
                  onError={() => {
                    setCustomLogo('');
                  }}
                />
              ...
              <div 
                className="w-32 h-32 md:w-36 md:h-36 rounded-[40px] flex items-center justify-center shadow-2xl shadow-blue-500/15 ring-4 ring-white" 
                style={{ backgroundColor: themeColors[appTheme][600] }}
              >
                <School className="text-white" size={64} />
              </div>
            )}
          </div>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="pt-4">
            ...
            <button 
              type="submit" 
              className="w-full text-white font-[950] text-sm py-5 rounded-2xl hover:shadow-2xl hover:shadow-blue-500/30 transition-all active:scale-[0.98] shadow-xl shadow-blue-500/15 uppercase tracking-widest cursor-pointer" 
              style={{ backgroundColor: themeColors[appTheme][600] }}
            >
              SİSTEME GİRİŞ YAP
            </button>
            ...
            <div className="text-center mt-6">
              <h1 className="text-2xl md:text-3xl font-[900] tracking-tight mb-1" style={{ color: themeColors[appTheme][900] }}>
                MaarifMerkezi.Com
              </h1>
              <p className="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] opacity-80">
          ...
          <div className="bg-white rounded-[40px] shadow-[0_32px_96px_rgba(0,0,0,0.16)] border border-gray-100 w-full max-w-4xl h-[85vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <div className="flex items-center justify-between px-8 py-6 border-b border-gray-100" style={{ backgroundColor: themeColors[appTheme][50] + '30' }}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-[900] tracking-tight" style={{ color: themeColors[appTheme][900] }}>MaarifMerkezi.Com - Maarif Asistanınız</h2>
            ...
            <div className="flex-1 overflow-y-auto p-8 md:p-10 space-y-6">
                ...
                <div className="space-y-6 animate-in fade-in duration-200">
                  <div className="max-w-3xl">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      Sadece ders notlarını ve devamsızlığı takip eden geleneksel yazılımların aksine MaarifMerkezi.Com; öğrencilerin ahlaki gelişimini, bireysel yeteneklerini, çoklu zeka profillerini, sosyal sorumluluklarını ve ders dışı kulüp faaliyetlerini yaşayan derinlikli bir <strong>bütüncül gelişim portfolyosuna</strong> dönüştürür.
                    </p>
                  </div>
              ...
              {activeAboutTab === 'necessity' && (
                <div className="space-y-6 animate-in fade-in duration-200">
                  <h3 className="text-2xl font-[900] tracking-tight mb-4" style={{ color: themeColors[appTheme][900] }}>
                    Neden MaarifMerkezi.Com'a İhtiyacımız Var?
                  </h3>
                  ...
                  <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
                    ...
                    <p>
                      <strong>MaarifMerkezi.Com, şu kritik eksiklikleri gidermek amacıyla geliştirilmiştir:</strong>
                    </p>
                    <ul className="list-disc leading-loose pl-6 space-y-2 text-gray-700 font-medium">
                      <li>
                        <strong className="text-gray-900 font-bold">Pasif Veri Tutma Sorunu:</strong> Rehberlik testleri çoğunlukla dosyalanıp rafa kaldırılır. MaarifMerkezi.Com ile öğrencilerin Çoklu Zeka verileri her an branş öğretmenlerinin görebileceği şekilde aktiftir.
                      </li>
                      <li>
                      ...
                      <li>
                        <strong className="text-gray-900 font-bold">Veli - Okul Kopukluğu:</strong> Veliler öğrencinin okuldaki sosyal/duygusal yolculuğundan ancak dönem sonu karne gününde haberdar olur. MaarifMerkezi.Com velileri sürecin her anına şeffaf anketler, gelişim kanalları ve ödev takip akışlarıyla entegre eder.
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-6 animate-in fade-in duration-200">
                  <div className="flex flex-col md:flex-row gap-6 items-start">
                    <div className="flex-1 space-y-4">
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed">
                        <strong>MaarifMerkezi.Com, bu modele doğrudan can suyu olan somut bir uygulamadır:</strong>
                      </p>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                    ...
                    <div className="p-5 rounded-2xl border border-gray-100 bg-white shadow-sm space-y-2">
                      ...
                      <p className="text-gray-600 text-[12.5px] leading-relaxed">
                        Maarif Modelinin "öğrenenin mizaç özelliklerini tanıma" ilkesi, MaarifMerkezi.Com'un barındırdığı <strong>"Öğrenme Stili (Çoklu Zeka)"</strong> modülüyle tam uyumludur. Her çocuğun öğrenme ritmi onurlandırılır.
                      </p>
                    </div>
              ...
              {activeAboutTab === 'modules' && (
                <div className="space-y-6 animate-in fade-in duration-200">
                  <h3 className="text-2xl font-[900] tracking-tight mb-2" style={{ color: themeColors[appTheme][900] }}>
                    MaarifMerkezi Eko-Sistem Modülleri ve Faydaları
                  </h3>
